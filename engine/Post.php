...
class Post
{
    ...
    public function write_page()
    {
        ...
        file_put_contents_as_dir_owner(Updater::$dest_path . '/' . $this->slug . Updater::$permalink_extension, $output_html);
    }
    ...
    public function write_permalink_page($draft = false)
    {
        ...
        if (! $draft || Updater::$write_public_drafts) {
            ...
            file_put_contents_as_dir_owner(Updater::$dest_path . ($draft ? '/drafts/' . $this->slug . Updater::$permalink_extension : $post_data['post-permalink'] . Updater::$permalink_extension), $output_html);
        }
        
        if ($draft) file_put_contents_as_dir_owner(Updater::$source_path . '/drafts/_previews/' . $this->slug . Updater::$permalink_extension, $output_html);
    }
